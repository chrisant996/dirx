...
"  -B, --almost-bare	Almost bare mode; displays one column per line, only\n"
"			the name field per line, hides . and .. directories,\n"
"			skips recursing into hidden directories, shows a mini\n"
"			directory header above file lists, quashes\n"
"			volume/header/summary output, disables filename\n"
"			justify, shows long file names, and shows '-' as\n"
"			size for dirs.\n"
