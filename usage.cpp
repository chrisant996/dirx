...
"			By default system and hidden files are not displayed.\n"
"  -b, --bare		Bare mode; only display names, no header/detail/etc.\n"
"  -i, --icons[=WHEN]	Display file icons using a Nerd Font (use '-? icons'\n"
"			for more info).\n"
"			  always    Always show icons\n"
"			  auto      Show icons unless output is redirected\n"
...
"			  c  Disable colors (use '-? colors' for more info)\n"
...
"			  all       Highlight all applicable fields\n"
"			  age       Highlight time fields\n"
"			  size      Highlight size fields\n"
"			  none      Don't highlight (default)\n"
"  --color-scale-mode=MODE\n"
"			The highlighting mode to use with --color-scale\n"
"			(use '-? colors' for more info).\n"
"			  fixed     Use custom field colors\n"
"			  gradient  Use a brightness gradient (default)\n"
...
"\n"
"FIELD OPTIONS:\n"
"  -c			List the compression ratio.\n"
"  -q, --owner		List the owner of the file.\n"
"  -r, --streams	List alternate data streams of the file.\n"
"  -S			List the file size even in multple column formats.\n"
"  -S[acf]		Which size field to display or use for sorting:\n"
"			  a  Allocation size\n"
"			  c  Compressed size\n"
"			  f  File size (default)\n"
"  -t, --attributes	List the file attributes.\n"
"  -T			List the file time even in multiple column formats.\n"
"  -T[acw]		Which time field to display or use for sorting:\n"
"			  a  Access time\n"
"			  c  Creation time\n"
...
"  -E[...]		Set the truncation character for file names that don't\n"
...
"  --justify[=WHEN]	Justify file names.  If WHEN is omitted, 'always' is\n"
"			assumed.\n"
"			  always    Always justify file names\n"
"			  fat       Justify only in FAT list format\n"
"			  normal    Justify only in normal list format\n"
"			  never     Do not justify file names (default)\n"
...
"  --escape-codes[=WHEN]\n"
"			Modern terminals can use escape codes for colors and\n"
"			hyperlinks.\n"
"			  always    Print escape codes\n"
"			  auto      Print unless output is redirected (default)\n"
"			  never     Do not print escape codes\n"
"  --nerd-fonts-version=VER\n"
"			Select which Nerd Fonts version to use.\n"
"			  3         Use icons from Nerd Fonts v3 (default)\n"
"			  2         Use icons compatible with Nerd Fonts v2\n"
